...
def gen_level_2():
    ...
    data["workflow"] = {
        "graph": {
            ...
            "edges": [
                {"id": "e1", "source": "start", "sourceHandle": "source", "target": "llm_node", "targetHandle": "target", "type": "custom"},
                {"id": "e2", "source": "llm_node", "sourceHandle": "source", "target": "end", "targetHandle": "target", "type": "custom"}
            ]
        }
    }
...
def gen_level_3():
    ...
    data["workflow"] = {
        "graph": {
            ...
            "edges": [
                {"id": "e1", "source": "start", "sourceHandle": "source", "target": "router", "targetHandle": "target", "type": "custom"},
                # 关键：检查 sourceHandle 是否对应 conditions 的 id
                {"id": "e2", "source": "router", "sourceHandle": "true", "target": "end_true", "targetHandle": "target", "type": "custom"},
                {"id": "e3", "source": "router", "sourceHandle": "false", "target": "end_false", "targetHandle": "target", "type": "custom"}
            ]
        }
    }
